...
int funcion = 0;    // Estado inicial en funcion 0 ->  Page-UP / Page-Down
                    // Estaco 1 -> <TAB> / <ENTER>
int Keypressed = 0; // Nos indica que tecla fue presionada
// *****************************************************************************
// *****************************************************************************
...
// IMPORTANTE, AÑADIR LOS OTROS DOS SWITCHES
...
/* Check if a key was pressed */
    ...
    // TECLA 1 PRESIONADA - funcionalidad
    ...
    // TECLA 2 PRESIONADA -> <PAGE-UP> / <TAB>
    ...
    // TECLA 3 PRESIONADA -> <Page-DOWN> / <ENTER>
...
void APP_EmulateKeyboard(void)
{
    ...
    if(appData.isSwitchPressed)
    {
        ...
        if(Keypressed == 1) // Realizamos el cambio de funcion
        {
            if(funcion == 0){
                funcion = 1;    
            }
        ...
        else if (Keypressed == 2) // Ejecutar funciones de la tecla 2
        {
            if(funcion == 0){
                appData.key = USB_HID_KEYBOARD_KEYPAD_KEYBOARD_PAGE_UP;
                ...
                appData.key = USB_HID_KEYBOARD_KEYPAD_KEYPAD_TAB;
                appData.keyCodeArray.keyCode[0] = appData.key;  
                Keypressed = 0;

            }
        }
        else if (Keypressed == 3) // Ejecutar funciones de la tecla 3
        {
            if(funcion == 0){
                appData.key = USB_HID_KEYBOARD_KEYPAD_KEYBOARD_PAGE_DOWN;
                appData.keyCodeArray.keyCode[0] = appData.key;
                Keypressed = 0;

            }
            else if(funcion == 1){
                appData.key = USB_HID_KEYBOARD_KEYPAD_KEYBOARD_RETURN_ENTER;
                appData.keyCodeArray.keyCode[0] = appData.key;    
                Keypressed = 0;
